      ...
      <>
        ...
        <PaperP>
          ...
          <Typography variant="body1" component="p" gutterBottom>
            The double sheet bend is mainly used in sailing to tie two different
            sized ropes together. The thicker rope should be used to form the
            bight. The knot works just as well for tying two same sized ropes
            together.
          </Typography>
        </PaperP>
        ...
        <PaperP>
          ...
          <Typography variant="body1" component="p" gutterBottom>
            The double sheet bend is similar to the single sheet bend, but has
            an extra wrap to provide more security.
          </Typography>
        ...
        <PaperP>
          ...
          <Typography variant="body1" component="p" gutterBottom>
            When tied correctly, the double sheet bend is a secure knot. It is
            more secure than the reef knot and single sheet bend. Not under
            tension, the double sheet bend can work loose. This also means that
            it is fairly easy to untie a double sheet bend when you take off the
            load.
          </Typography>
        </PaperP>
      </>
