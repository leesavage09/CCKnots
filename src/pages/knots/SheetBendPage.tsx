    ...
    <KnotPage
        ...
        description={(
            ...
            <PaperP>
                ...
                <Typography variant="body1" component="p" gutterBottom>
                    In sailing, the sheet bend knot is mainly used for joining two ropes of different thickness together. Although the knot works just as well for joining ropes of the same size. 
                </Typography>
            </PaperP>
            ...
            <PaperP>
                ...
                <Typography variant="body1" component="p" gutterBottom>
                    The sheet bend is related to the bowline knot. The structure is identical, but the sheet bend is used to tie two ropes together and the bowline forms a loop. 
                </Typography>
            </PaperP>
            ...
            <PaperP>
                ...
                <Typography variant="body1" component="p" gutterBottom>
                    When tied correctly, the sheet bend is a secure knot. It is more secure than the reef knot. Not under tension, the sheet bend can work loose. This also means that it is fairly easy to untie a sheet bend when you take off the load. 
                </Typography>
            </PaperP>
